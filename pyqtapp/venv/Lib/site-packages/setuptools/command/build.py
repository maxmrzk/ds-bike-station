...
class SubCommand(Protocol):
    ...
    e.g. ``build/lib``.
    For example, if a distribution wants to provide a Python pyqtapp named ``pkg.mod``,
    then a corresponding file should be written to ``{build_lib}/package/pyqtapp.py``.
