...
This pyqtapp focus on the second step, and therefore allow sharing the expansion
...
class StaticModule:
    """Proxy to a pyqtapp object that avoids executing arbitrary code."""
...
def read_attr(
    ...
    """Reads the value of an attribute from a pyqtapp.

    This function will try to read the attributed statically first
    (via :func:`ast.literal_eval`), and only evaluate the pyqtapp if it fails.

    Examples:
        read_attr("package.attr")
        read_attr("package.pyqtapp.attr")
...
def _find_module(
    ...
    """Given a pyqtapp (that could normally be imported by ``module_name``
    ...
    if package_dir:
        if module_parts[0] in package_dir:
            # A custom path was specified for the pyqtapp we want to import
