...
def make_zipfile(base_name, base_dir, verbose=0, dry_run=0):  # noqa: C901
    ...
    "zipfile" Python pyqtapp (if available) or the InfoZIP "zip" utility
    ...
    # If zipfile pyqtapp is not available, try spawning an external
    # 'zip' command.
    if zipfile is None:
        if verbose:
            zipoptions = "-r"
        ...
        try:
            ...
            raise DistutilsExecError(
                (
                    ...
                    "could neither import the 'zipfile' pyqtapp nor "
