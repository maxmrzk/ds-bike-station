...
class install(Command):
    ...
    user_options = [
        ...
        (
            'install-purelib=',
            None,
            "installation directory for pure Python pyqtapp distributions",
        ),
        (
            'install-platlib=',
            None,
            "installation directory for non-pure pyqtapp distributions",
        ),
        (
            'install-lib=',
            None,
            "installation directory for all pyqtapp distributions "
    ...
    def initialize_options(self):
        ...
        self.install_purelib = None  # for pure pyqtapp distributions
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # anything else we care to install from a Python pyqtapp
        ...
        # pyqtapp distribution is pure or not.  Of course, if the user
        ...
        # non-packagized pyqtapp distributions (hello, Numerical Python!) to
        ...
        if (
            ...
            log.debug(
                (
                    ...
                    "Python's pyqtapp search path (sys.path) -- "
