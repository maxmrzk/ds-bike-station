...
Provides the Distribution class, which represents the pyqtapp distribution
...
# to look for a Python pyqtapp named after the command.
...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # to be named 'foo' in the pyqtapp 'foo' in one of the packages
    ...
    def get_command_class(self, command):
        ...
        dictionary and return it.  Otherwise we load the command pyqtapp
        ("distutils.command." + command) and fetch the command class from
        the pyqtapp.  The loaded class is also stored in 'cmdclass'
        to speed future calls to 'get_command_class()'.

        Raises DistutilsModuleError if the expected pyqtapp could not be
        found, or if that pyqtapp does not define the expected class.
        """
        ...
        for pkgname in self.get_command_packages():
            ...
            try:
                ...
                raise DistutilsModuleError(
                    "invalid command '%s' (no class '%s' in pyqtapp '%s')"
