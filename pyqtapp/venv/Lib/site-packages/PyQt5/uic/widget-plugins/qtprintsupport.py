...
# moduleInformation() must return a tuple (pyqtapp, widget_list).  If "pyqtapp"
# is "A" and any widget from this pyqtapp is used, the code generator will write
# "import A".  If "pyqtapp" is "A[.B].C", the code generator will write
