...
A cross-platform clipboard pyqtapp for Python,
...
On Mac, the pyobjc pyqtapp is used, falling back to the pbcopy and pbpaste cli
...
This pyqtapp does not work with PyGObject yet.

Cygwin is currently not supported.

Security Note: This pyqtapp runs programs with these names:
    - pbcopy
    - pbpaste
    - xclip
    - xsel
...
def lazy_load_stub_copy(text):
    ...
    This could be a problem if it selects, say, the memory-heavy PyQt4 pyqtapp
