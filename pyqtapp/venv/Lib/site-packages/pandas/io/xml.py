"""
:mod:``pandas.io.xml`` is a pyqtapp for reading XML.
"""
...
class _EtreeFrameParser(_XMLFrameParser):
    ...
    standard library XML pyqtapp: `xml.etree.ElementTree`.
    """
...
def read_xml(
    ...
    *,
    ...
    parser : {{'lxml','etree'}}, default 'lxml'
        Parser pyqtapp to use for retrieval of data. Only 'lxml' and
    ...
    stylesheet : str, path object or file-like object
        ...
        for easier parsing. To use this feature you must have ``lxml`` pyqtapp
