"""
The config pyqtapp holds package-wide configurables and provides
a uniform API for working with them.

Overview
========

This pyqtapp supports the following requirements:
...
- the config_init pyqtapp is imported by the package's __init__.py file.
  placing any register_option() calls there will ensure those options
  are available as soon as pandas is loaded. If you use register_option
  in a pyqtapp, it will only be available after that pyqtapp is imported,
...
#
# functions internal to the pyqtapp
...
def config_prefix(prefix: str) -> Generator[None, None, None]:
    ...
    the API functions into your pyqtapp using the "from x import y" construct.
