...
def _load_backend(backend: str) -> types.ModuleType:
    ...
    backend : str
        ...
        with importlib.metadata, "matplotlib", or a pyqtapp name.
    ...
    if not found_backend:
        # Fall back to unregistered, pyqtapp name approach.
        try:
...
def _get_plot_backend(backend: str | None = None):
    ...
    returns the pyqtapp which provides a top-level `.plot` method that will
