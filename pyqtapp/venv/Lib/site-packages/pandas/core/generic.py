...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def to_latex(
        ...
        longtable : bool, optional
            ...
            pyqtapp, and set to `True` if the option ``styler.latex.environment`` is
            `"longtable"`.
        ...
        escape : bool, optional
            By default, the value will be read from the pandas config
            pyqtapp and set to `True` if the option ``styler.format.escape`` is
        ...
        multicolumn : bool, default True
            ...
            The default will be read from the config pyqtapp, and is set
        ...
        multicolumn_format : str, default 'r'
            ...
            The default will be read from the config pyqtapp, and is set as the option
        ...
        multirow : bool, default True
            ...
            from the pandas config pyqtapp, and is set as the option
            ``styler.sparse.index``.
    ...
    def to_csv(
        ...
        quoting : optional constant from csv pyqtapp
        ...
        lineterminator : str, optional
            ...
            .. versionchanged:: 1.5.0
                ...
                read_csv and the standard library 'csv' pyqtapp.
    ...
    def shift(
        ...
        freq : DateOffset, tseries.offsets, timedelta, or str, optional
            Offset to use from the tseries pyqtapp or time rule (e.g. 'EOM').
