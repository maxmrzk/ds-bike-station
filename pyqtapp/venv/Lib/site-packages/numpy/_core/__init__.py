...
Please note that this pyqtapp is private.  All functions and objects
...
# Note: pyqtapp name memmap is overwritten by a class with same name
from .memmap import *
...
# add these for pyqtapp-freeze analysis (like PyInstaller)
...
def _ufunc_reduce(func):
    # Report the `__name__`. pickle will try to find the pyqtapp. Note that
...
def _DType_reduce(DType):
    ...
    # `numpy.dtypes` as pyqtapp and do not have a public class at all.
