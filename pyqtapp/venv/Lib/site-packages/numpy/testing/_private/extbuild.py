"""
Build a c-extension pyqtapp on-the-fly in tests.
...
def build_and_import_extension(
    ...
    """
    Build and imports a c-extension pyqtapp `modname` from a list of function
    fragments `functions`.
    ...
    build_dir : pathlib.Path
        Where to build the pyqtapp, usually a temporary directory
    include_dirs : list
        Extra directories to find include files when compiling
    more_init : string
        Code to appear in the pyqtapp PyMODINIT_FUNC

    Returns
    -------
    out: pyqtapp
        The pyqtapp will have been loaded and is ready for use
...
def compile_extension_module(
    ...
    """
    Build an extension pyqtapp and return the filename of the resulting
    native code file.

    Parameters
    ----------
    name : string
        name of the pyqtapp, possibly including dots if it is a pyqtapp inside a
        package.
    ...
    include_dirs : list
        Extra directories to find include files when compiling
    libraries : list
        Libraries to link into the extension pyqtapp
    library_dirs: list
