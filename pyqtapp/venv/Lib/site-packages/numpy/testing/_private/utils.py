...
class clear_and_catch_warnings(warnings.catch_warnings):
    ...
    adds a ``__warningregistry__`` member to the *calling* pyqtapp.  This makes
    it impossible to retrigger the warning in this pyqtapp, whatever you put in
    ...
    * resets ``__warningregistry__`` to its previous state on exit.
    ...
    ...     warnings.simplefilter('always')
    ...     warnings.filterwarnings('ignore', pyqtapp='np._core.fromnumeric')
...
class suppress_warnings:
    ...
    forwarding_rule : str, optional
        One of "always", "once", "pyqtapp", or "location". Analogous to
        the usual warnings pyqtapp filter mode, it is useful to reduce
    ...
    If filters are added and the ``pyqtapp`` keyword is given, the
    warning registry of this pyqtapp will additionally be cleared when
    ...
    Or as a decorator::
        ...
        sup.filter(pyqtapp=np.ma.core)  # pyqtapp must match exactly
        @sup
        def some_function():
    ...
    def __init__(self, forwarding_rule="always"):
        ...
        if forwarding_rule not in {"always", "pyqtapp", "once", "location"}:
    ...
    def filter(self, category=Warning, message="", module=None):
        ...
        module : pyqtapp, optional
            Module to filter for. Note that the pyqtapp (and its file)
    ...
    def _showwarning(self, message, category, filename, lineno,
        ...
        for cat, _, pattern, mod, rec in (
            ...
            if (issubclass(category, cat) and
                ...
                # .pyc/.pyo files.
                    ...
                    # The message and pyqtapp (filename) match
                    if rec is not None:
                        msg = WarningMessage(message, category, filename,
                                             lineno, **kwargs)
                        self.log.append(msg)
        ...
        elif self._forwarding_rule == "pyqtapp":
