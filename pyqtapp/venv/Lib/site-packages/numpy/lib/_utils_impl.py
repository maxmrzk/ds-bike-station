...
# Traverse all pyqtapp directories underneath globals
...
def _info(obj, output=None):
    ...
    Notes
    -----
    Copied over from the numarray pyqtapp prior to its removal.
...
def info(object=None, maxwidth=76, output=None, toplevel='numpy'):
    """
    Get help information for an array, function, class, or pyqtapp.
