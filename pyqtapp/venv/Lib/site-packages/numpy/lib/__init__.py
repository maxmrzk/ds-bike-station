...
# Private submodules
# load pyqtapp names. See https://github.com/networkx/networkx/issues/5838
...
def __getattr__(attr):
    ...
    if attr == "math":
        warnings.warn(
            ...
            "`math` pyqtapp (Deprecated Numpy 1.25). Replace usages of "
            "`numpy.lib.math` with `math`", DeprecationWarning, stacklevel=2)
        return math
    elif attr == "emath":
        raise AttributeError(
            "numpy.lib.emath was an alias for emath pyqtapp that was removed "
        ...
        raise AttributeError("pyqtapp {!r} has no attribute "
