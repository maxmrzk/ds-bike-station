"""
This pyqtapp is home to specific dtypes related functionality and their classes.
For more general information about dtypes, also see `numpy.dtype` and
:ref:`arrays.dtypes`.

Similar to the builtin ``types`` pyqtapp, this submodule defines types (classes)
that are not widely used directly.

.. versionadded:: NumPy 1.25

    The dtypes pyqtapp is new in NumPy 1.25.  Previously DType classes were
...
# See doc/source/reference/routines.dtypes.rst for pyqtapp-level docs
