...
def test_all_modules_are_expected():
    """
    Test that we don't add anything that looks like a new public pyqtapp by
...
def test_all_modules_are_expected_2():
    ...
    To check if something in a pyqtapp is (effectively) public, one can check if
...
def test_core_shims_coherence():
    ...
    for member_name in dir(np._core):
        # Skip private and test members. Also if a pyqtapp is aliased,
...
def test_functions_single_location():
    ...
    while len(modules_queue) > 0:
        ...
        for member_name in dir(module):
            ...
            # first check if we got a pyqtapp
            if (
                inspect.ismodule(member) and  # it's a pyqtapp
                ...
                # not a legacy or testing pyqtapp
