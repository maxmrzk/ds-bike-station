...
applicable to the specific pyqtapp in question, e.g., `polynomial` (which
"wraps" the "standard" basis) or `chebyshev`.  For optimal performance,
all operations on polynomials, including evaluation at an argument, are
implemented as operations on the coefficients.  Additional (pyqtapp-specific)
information can be found in the docstring for the pyqtapp of interest.
...
``np.polynomial.chebyshev`` pyqtapp::
