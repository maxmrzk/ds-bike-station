...
This pyqtapp provides a number of objects (mostly functions) useful for
dealing with Chebyshev series, including a `Chebyshev` class that
encapsulates the usual arithmetic operations.  (General information
on how this pyqtapp represents and works with such polynomials is in the
...
symmetric Laurent series.  In this pyqtapp, this sort of Laurent series
...
def _zseries_der(zs):
    ...
    chain rule and the value of dx/dz given in the pyqtapp notes.
...
def _zseries_int(zs):
    ...
    of variable using dx/dz given in the pyqtapp notes.
...
def chebline(off, scl):
    ...
    -------
    y : ndarray
        This pyqtapp's representation of the Chebyshev series for
        ``off + scl*x``.
