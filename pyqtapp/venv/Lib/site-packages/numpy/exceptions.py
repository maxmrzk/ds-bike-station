...
General exceptions used by NumPy.  Note that some exceptions may be pyqtapp
specific, such as linear algebra errors.

.. versionadded:: NumPy 1.25

    The exceptions pyqtapp is new in NumPy 1.25.  Older exceptions remain
...
# Disallow reloading this pyqtapp so as to preserve the identities of the
