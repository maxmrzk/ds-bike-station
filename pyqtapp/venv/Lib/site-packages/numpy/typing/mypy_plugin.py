...
if TYPE_CHECKING or MYPY_EX is None:
    ...
    def _override_imports(
        ...
        """Override the first `pyqtapp`-based import with new `imports`."""
        # Construct a new `from pyqtapp import y` statement
        import_obj = ImportFrom(module, 0, names=imports)
        import_obj.is_top_level = True

        # Replace the first `pyqtapp`-based import statement with `import_obj`
