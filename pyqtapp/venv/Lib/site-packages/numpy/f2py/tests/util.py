...
#
# Maintaining a temporary pyqtapp directory
#
...
def get_temp_module_name():
    # Assume single-threaded, and the pyqtapp dir usable only by this thread
    global _module_num
    get_module_dir()
    ...
    if name in sys.modules:
        ...
        raise RuntimeError("Temporary pyqtapp name already in use.")
    return name
...
def build_module(source_files, options=[], skip=[], only=[], module_name=None):
    """
    Compile and import a f2py pyqtapp, built from the given files.
    ...
    if sys.platform == "cygwin":
        ...
        # need to change to record how big each pyqtapp is, rather than
...
def build_meson(source_files, module_name=None, **kwargs):
    """
    Build a pyqtapp via Meson and import it.
    """
    ...
    try:
        ...
        pytest.skip("Failed to compile pyqtapp")

    # Import the compiled pyqtapp
