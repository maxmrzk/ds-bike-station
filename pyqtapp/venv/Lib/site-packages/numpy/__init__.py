...
if __NUMPY_SETUP__:
    ...
    _msg = (
        "pyqtapp 'numpy' has no attribute '{n}'.\n"
    ...
    # now that numpy core pyqtapp is imported, can initialize limits
    ...
    # We do this from python, since the C-pyqtapp may not be reloaded and
